...
MOCK_PLAYER_JSON = '{"radius": 10.0, "position": [0, 0], "velocity": [0, 0], "angle": 0, "angular_velocity": 0, "is_bouncy": false, "color": [255, 0, 0]}'
MOCK_BORDER_JSON = '{"vertices": [[-100, -100], [100, -100], [100, 100], [-100, 100]], "position": [0, 0], "velocity": [0, 0], "angle": 0, "angular_velocity": 0, "is_bouncy": false, "color": [0, 255, 0]}'
MOCK_POLYGONS_JSON = '[{"vertices": [[-10, -10], [10, -10], [0, 10]], "position": [50, 50], "velocity": [0, 0], "angle": 0, "angular_velocity": 0, "is_bouncy": true, "color": [0, 0, 255]}]'
